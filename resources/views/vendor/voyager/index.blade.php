...
@section('content')
    ...
    <div class="container-fluid">
        <h3 style="text-align:center;">Bem vindo ao Sistema de Cadastro de Pessoal da DHN, {{ Auth::user()->name }}</h3>
            <p style="text-align:center;">
            fgvfdvvdfvfdxvfgbg<br>
            vfdvxdfvdfgvbfdgbgbgfxbf<br>
            bfbdgbdxbxbgdbgbgbb<br>
            bfbdgbdxbxbgdbgbgbb<br>        
            </p>
